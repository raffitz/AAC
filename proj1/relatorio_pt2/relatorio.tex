...
\begin{document}
	...
	%\section{Testes e Simulações} <== Fazemos? Querem meter? /!\ Se sim metemos fotos, ou só texto? Se calhar era melhor meter fotos... Na m'apetece nada. But a man's gotta do what a man's gotta do.
